...
# This function is a countdown til Christmas & my birthday
def time_stamp():
    today = datetime.date.today()
    future = datetime.date(2021, 12, 25)
    b_day = datetime.date(2021, 9, 20)
    birth = b_day - today
    diff = future - today
    print(diff.days, "days til Christmas, and", birth.days, "til my Birthday!")
    return diff.days
...
# This puts the values of mydict.values into a list
